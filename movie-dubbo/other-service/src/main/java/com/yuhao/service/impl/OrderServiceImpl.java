...
public class OrderServiceImpl implements OrderService {
    ...
    public List<String> listSaledSeats(Integer showTimeId) {
        return orderMapper.listSaledSeats(showTimeId);
    }


    public Order selectOrderForLock(@RequestParam("orderNo") String orderNo) {
        return orderMapper.selectOrderForLock(orderNo);
    }
