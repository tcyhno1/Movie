...
public class MailUtil {
    ...
    //邮件服务账号设置
    private static String mail_server = "290173403@qq.com";
    private static String password = "dbwxjchfvevnbgcj";
...
class TestMail{
    public static void main(String[] args) {
        MailUtil.sendTextMail("3405642025@qq.com","test","【大猿国际影城】您的验证码：666999");
    }
}